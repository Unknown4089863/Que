...
$sa(form, "style", "padding:1%;position:fixed;right:1%;width:16%;font-weight:600;")
      ...
      $sa(loginBtn, "style", "padding:1%;position:fixed;right:1%;width:16%;top:6%;font-weight:600;")
      $a(form, loginBtn)
      $a(header, form);
...
dbcontent ="Fail to fetch";
      ...
      <p>${dbcontent}</p><img src=${imgFile} alt="${fileName}" style="width:90%;margin:5%"></div>`;
      $a(divis, topic);
      $a(divis, data(CreaterEmail,"&#128077;", "100", "&#128228;", "200",num));
      return divis;
    }
    ...
    function data(CreaterEmail,img1, num1, img2, num2,numSno) {
